 ...
 * ──────────────────────────────────────────────────────────────────
 * Ch I (Prologue) and Ch II (Rising Tension) merged into single
 * 3-node chapter. Ch III (Branching) becomes 5 nodes (TRUNK_04-08).
 * Ch IV and V (House branches + Endings) remain unchanged.
 *
 * FLAG SYSTEM (unchanged):
 *   spared_thief      Set in TRUNK_01/02. Unlocks mercy payoff in Ch III.
 *   killed_thief      Set in TRUNK_01/02. Enables ruthlessness bonus.
 *   found_secret_letter  Set in TRUNK_02. Unlocks intelligence advantage.
 *
 * ──────────────────────────────────────────────────────────────────
 * NODE ID REFERENCE (full map)
 * ──────────────────────────────────────────────────────────────────
 * Trunk        1–8 (was 1–15)
 * STARK_A/B    9, 10     LANN_A/B     11, 12    TARG_A/B     13, 14
 * BARA_A/B     15, 16    TYR_A/B      17, 18    MART_A/B     19, 20
 * TUL_A/B      21, 22    ARR_A/B      23, 24    GREY_A/B     25, 26
 * COMM_A/B     27, 28
 * END_COMM_GOOD 29  END_COMM_BAD 30  END_COMM_DEBT 31  END_COMM_HONOR 32
 * END_STARK 33  END_LANN 34  END_TARG 35  END_BARA 36  END_TYR  37
 * END_MART  38  END_TUL  39  END_ARR  40  END_GREY  41
 */
class NodesSeeder extends Seeder
{
    private const N = [
        ...
        // House branches (Ch IV) — shifted down
    ...
    public function run(): void
    {
        ...
        $nodes = [
            ...
            [
                $n['TRUNK_05'], 'TRUNK_05', 'Chapter II: The Branching',
                'The Letter from Home',
                'A raven arrives bearing your house\'s seal — or the seal of the Wanderer\'s guild, if you ride for no lord. The message is brief and written in a hand that trembles: "They know you are here. They know what you know. Do not trust the Lannister gold. Do not trust the northern silence. Come home or do not come home at all."\n\nThe crossbow bolt takes your candle instead of your throat — close enough to leave a burn on your cheek. In the dark you hear boots retreating. They were professionals. They were paid.',
                null, 60, false,
            ],
            [
                $n['TRUNK_06'], 'TRUNK_06', 'Chapter II: The Branching',
                'The Confession in the Sept',
                'In the Sept of Baelor, an old septon presses a folded parchment into your hand and dies three steps later — no wound, no struggle, simply done. The parchment contains a single name and a location. Whether this is a gift, a trap, or both, you cannot yet say. If you already know the name from the letter at the inn — if you\'ve carried it quietly for weeks — the confirmation lands differently. Not as a revelation. As a verdict.\n\nA feast is declared in honor of nothing in particular. Every great lord in the city attends. Alliances are made in whispered toasts.',
                'The debts of the gods are paid in blood and years.',
                65, false,
            ],
            [
                $n['TRUNK_07'], 'TRUNK_07', 'Chapter II: The Branching',
                'The Council of Banners',
                'Every great house that has a presence in King\'s Landing sends a representative to a secret meeting beneath the Street of Steel. They all want the same thing: survival. But survival means something different to each of them. The chair at the head of the table is yours, if you want it. The moment you sit, you choose a side.\n\nThere are those here who remember the boy on the road — who heard what you did, and have drawn their own conclusions about the kind of person you are. The merchant from the Crossroads has made it to King\'s Landing, and he has been speaking to the wrong people.',
                'A chair at this table costs more than gold.',
                65, false,
            ],
            [
                $n['TRUNK_08'], 'TRUNK_08', 'Chapter II: The Branching',
                'The Point of No Return',
                'You have seen the ledgers, survived the assassins, and read the dying man\'s note. The picture is complete and it is ugly. The city will burn — the question is who holds the torch and who controls the ashes. You cannot leave. You cannot stay neutral. The decision you make in the next hour will define the rest of your life.\n\nA shadow slips through the door of your anteroom — the thin boy from the Crossroads, older now, wearing a minor lord\'s livery. He sets a sealed document on your desk without a word. His eyes say: we are even.',
                'Every debt compounds. Every choice narrows.',
                70, false,
            ],

            // ══════════════════════════════════════════════════════
            // CHAPTER III — HOUSE BRANCHES
            // ══════════════════════════════════════════════════════

            [
                $n['STARK_A'], 'STARK_A', 'Chapter III: The House Quests',
                'The Wolf\'s Price',
            ...
            [
                $n['STARK_B'], 'STARK_B', 'Chapter III: The House Quests',
                'The Crypts Remember',
            ...
            [
                $n['LANN_A'], 'LANN_A', 'Chapter III: The House Quests',
                'Gold and Leverage',
            ...
            [
                $n['LANN_B'], 'LANN_B', 'Chapter III: The House Quests',
                'The Lions\' Gambit',
            ...
            [
                $n['TARG_A'], 'TARG_A', 'Chapter III: The House Quests',
            ...
            [
                $n['TARG_B'], 'TARG_B', 'Chapter III: The House Quests',
            ...
            [
                $n['BARA_A'], 'BARA_A', 'Chapter III: The House Quests',
                'The Stag at Bay',
            ...
            [
                $n['BARA_B'], 'BARA_B', 'Chapter III: The House Quests',
            ...
            [
                $n['TYR_A'], 'TYR_A', 'Chapter III: The House Quests',
                'The Garden Party',
            ...
            [
                $n['TYR_B'], 'TYR_B', 'Chapter III: The House Quests',
            ...
            [
                $n['MART_A'], 'MART_A', 'Chapter III: The House Quests',
            ...
            [
                $n['MART_B'], 'MART_B', 'Chapter III: The House Quests',
            ...
            [
                $n['TUL_A'], 'TUL_A', 'Chapter III: The House Quests',
            ...
            [
                $n['TUL_B'], 'TUL_B', 'Chapter III: The House Quests',
                'The Riverlands\' Oath',
            ...
            [
                $n['ARR_A'], 'ARR_A', 'Chapter III: The House Quests',
            ...
            [
                $n['ARR_B'], 'ARR_B', 'Chapter III: The House Quests',
                'As High as Honor',
            ...
            [
                $n['GREY_A'], 'GREY_A', 'Chapter III: The House Quests',
                'The Iron Price',
            ...
            [
                $n['GREY_B'], 'GREY_B', 'Chapter III: The House Quests',
                'We Do Not Sow',
            ...
            [
                $n['COMM_A'], 'COMM_A', 'Chapter III: The House Quests',
                'No Name, No Banner',
            ...
            [
                $n['COMM_B'], 'COMM_B', 'Chapter III: The House Quests',
            ...
            [
                $n['END_COMM_GOOD'], 'END_COMM_GOOD', 'Chapter IV: The Resolution',
            ...
            [
                $n['END_COMM_BAD'], 'END_COMM_BAD', 'Chapter IV: The Resolution',
            ...
            [
                $n['END_COMM_DEBT'], 'END_COMM_DEBT', 'Chapter IV: The Resolution',
            ...
            [
                $n['END_COMM_HONOR'], 'END_COMM_HONOR', 'Chapter IV: The Resolution',
                'Forsaken',
            ...
            [
                $n['END_STARK'], 'END_STARK', 'Chapter IV: The Resolution',
                'The North Remembers',
            ...
            [
                $n['END_LANN'], 'END_LANN', 'Chapter IV: The Resolution',
            ...
            [
                $n['END_TARG'], 'END_TARG', 'Chapter IV: The Resolution',
                'Fire Reborn',
            ...
            [
                $n['END_BARA'], 'END_BARA', 'Chapter IV: The Resolution',
                'The Fury Justified',
            ...
            [
                $n['END_TYR'], 'END_TYR', 'Chapter IV: The Resolution',
                'The Rose Ascendant',
            ...
            [
                $n['END_MART'], 'END_MART', 'Chapter IV: The Resolution',
                'The Sunspear Accord',
            ...
            [
                $n['END_TUL'], 'END_TUL', 'Chapter IV: The Resolution',
                'The River Runs True',
            ...
            [
                $n['END_ARR'], 'END_ARR', 'Chapter IV: The Resolution',
            ...
            [
                $n['END_GREY'], 'END_GREY', 'Chapter IV: The Resolution',
        ...
        $total = count($nodes);
        $this->command->info("NodeSeeder: {$total} nodes seeded (medium trim: 3 + 5 + 20 house + 13 endings).");
    }
}
