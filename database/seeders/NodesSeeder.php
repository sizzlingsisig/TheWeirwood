...
class NodesSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $nodes = [
            ...
            // ──────────────────────────────────────────────────
            // CHAPTER II — THE RISING TENSION  (Trunk 06–10)
            // ──────────────────────────────────────────────────
            [
                $n['TRUNK_06'],
                'TRUNK_06',
            ...
            // ──────────────────────────────────────────────────
            // CHAPTER III — THE BRANCHING  (Trunk 11–15)
            // ──────────────────────────────────────────────────
            [
                $n['TRUNK_11'],
                'TRUNK_11',
                ...
                'The King\'s Illness',
                'The maesters speak of a fever. The gossips speak of poison. The King has not appeared in three days, and in his absence the Red Keep has fractured into a dozen competing courts, each convinced it will inherit what comes next. You stand at the center of the storm.',
                null, 60, false, null,
            ],
            [
                $n['TRUNK_12'],
            ...
            [
                ...
                'In the Sept of Baelor, an old septon presses a folded parchment into your hand and dies three steps later — no wound, no struggle, simply done. The parchment contains a single name and a location. Whether this is a gift, a trap, or both, you cannot yet say.',
            ...
            // ──────────────────────────────────────────────────
            // CHAPTER IV — HOUSE STARK BRANCH
            // ──────────────────────────────────────────────────
            [
                $n['STARK_A'],
                'STARK_A',
                'Chapter IV: The House Quests',
                'The Wolf\'s Price',
            ...
            // ──────────────────────────────────────────────────
            // CHAPTER IV — HOUSE LANNISTER BRANCH
            // ──────────────────────────────────────────────────
            [
                $n['LANN_A'],
                'LANN_A',
            ...
            // ──────────────────────────────────────────────────
            // CHAPTER IV — HOUSE TARGARYEN BRANCH
            // ──────────────────────────────────────────────────
            [
                $n['TARG_A'],
                'TARG_A',
            ...
            // ──────────────────────────────────────────────────
            // CHAPTER IV — HOUSE BARATHEON BRANCH
            // ──────────────────────────────────────────────────
            [
                $n['BARA_A'],
                'BARA_A',
            ...
            // ──────────────────────────────────────────────────
            // CHAPTER IV — HOUSE TYRELL BRANCH
            // ──────────────────────────────────────────────────
            [
                $n['TYR_A'],
                'TYR_A',
            ...
            // ──────────────────────────────────────────────────
            // CHAPTER IV — HOUSE MARTELL BRANCH
            // ──────────────────────────────────────────────────
            [
                $n['MART_A'],
                'MART_A',
            ...
            // ──────────────────────────────────────────────────
            // CHAPTER IV — HOUSE GREYJOY BRANCH
            // ──────────────────────────────────────────────────
            [
                $n['GREY_A'],
                'GREY_A',
            ...
            // ──────────────────────────────────────────────────
            // CHAPTER V — ENDING NODES (13 terminal nodes)
            // ──────────────────────────────────────────────────
            [
                $n['END_COMM_GOOD'],
                'END_COMM_GOOD',
                'Chapter V: The Resolution',
