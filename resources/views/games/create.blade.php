                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <label class="cursor-pointer">
                            <input type="radio" name="entry_mode" value="map" class="peer sr-only" {{ $userHouses->isEmpty() ? 'disabled' : '' }}>
                            <div class="p-4 rounded-lg border-2 border-gray-200 dark:border-gray-700 peer-checked:border-red-500 peer-checked:bg-red-50 dark:peer-checked:bg-red-900 hover:border-gray-300 transition {{ $userHouses->isEmpty() ? 'opacity-50' : '' }}">
                                <div class="text-center">
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                        @if($userHouses->isEmpty())
                                            🔒 Unlock houses to use
                                        @else
                                            Choose your house directly
                                        @endif
                                    </p>
                                </div>
                            </div>
                        ...
                        <label class="cursor-pointer">
                            <input type="radio" name="entry_mode" value="blind" class="peer sr-only" checked>
