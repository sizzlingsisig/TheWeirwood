...
<main>
        ...
        <section class="py-24 px-6 border-t border-[var(--bark)]/30" id="entry">
            <div class="max-w-5xl mx-auto">
                ...
                <div class="text-center mb-14">
                    <p class="font-['Cinzel'] text-[0.7rem] tracking-[0.4em] text-[var(--gold)] uppercase mb-3">Two Gates</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    @foreach([
                        ...
                        [
                            ...
                            'title' => 'Enter Blindly',
                            'body'  => 'Valar morghulis!! Walk into the dark and see what the tree offers.',
                        ],
                    ] as $card)
    ...
    <footer class="border-t border-[var(--bark)]/30 py-8 px-6 bg-[rgba(26,21,18,0.4)]">
        <div class="max-w-6xl mx-auto flex flex-col items-center justify-center gap-4">
            <span class="font-['Cinzel'] text-[0.6rem] tracking-[0.3em] uppercase text-[rgba(107,90,78,0.4)] text-center w-full block">
